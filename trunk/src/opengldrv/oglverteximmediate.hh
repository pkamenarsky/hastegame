#ifndef ION_OPENGLDRV_OGLVERTEXIMMEDIATE_HH_INCLUDED
#define ION_OPENGLDRV_OGLVERTEXIMMEDIATE_HH_INCLUDED
...
namespace opengldrv {
	...
	class ION_API OGLVertexImmediate:public video::Vertexstream
	{
	public:
		OGLVertexImmediate(OGLDevice& rOGLDevice,const ion_uint32 numVertices,
