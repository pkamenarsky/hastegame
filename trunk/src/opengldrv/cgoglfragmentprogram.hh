#ifndef ION_OPENGLDRV_CGOGLFRAGMENTPROGRAM_HH_INCLUDED
#define ION_OPENGLDRV_CGOGLFRAGMENTPROGRAM_HH_INCLUDED
...
namespace opengldrv {
	...
	class ION_API CGOGLFragmentprogram:public video::Program
	{
	public:
		CGOGLFragmentprogram(OGLDevice& ogldevice,const base::String& identifier,
			const base::String& entrypoint,const base::String& program);
		~CGOGLFragmentprogram();
