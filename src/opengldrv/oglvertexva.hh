#ifndef ION_OPENGLDRV_OGLVERTEXVA_HH_INCLUDED
#define ION_OPENGLDRV_OGLVERTEXVA_HH_INCLUDED
...
namespace opengldrv {
	...
	class ION_API OGLVertexVA:public video::Vertexstream
	{
	public:
		OGLVertexVA(OGLDevice& rOGLDevice,const ion_uint32 numVertices,
