#ifndef ION_OPENGLDRV_OGLINDEXIMMEDIATE_HH_INCLUDED
#define ION_OPENGLDRV_OGLINDEXIMMEDIATE_HH_INCLUDED
...
namespace opengldrv {
	...
	class ION_API OGLIndexImmediate:public video::Indexstream
	{
	public:
		OGLIndexImmediate(OGLDevice& rOGLDevice,
