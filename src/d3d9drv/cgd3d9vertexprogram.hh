#ifndef ION_D3D9DRV_CGD3D9VERTEXPROGRAM_HH_INCLUDED
#define ION_D3D9DRV_CGD3D9VERTEXPROGRAM_HH_INCLUDED
...
#ifdef ION_D3D9DRV_CGD3D9VERTEXPROGRAM_IMPLEMENTATION
#include <map>
#endif
...
namespace d3d9drv {
	...
	class ION_API CGD3D9Vertexprogram:public video::Program
	{
	public:
		CGD3D9Vertexprogram(D3D9Device& d3d9device,const base::String& identifier,
